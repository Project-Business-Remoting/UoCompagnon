...
import { processNotifications, markSmartAsRead, markAllSmartAsRead, deleteSmartNotif } from '../utils/notificationUtils';
...
const Notifications = () => {
  ...
  const hasUnreadSystem = notifications.some((n) => !n.isRead && !n.isSmartNotification);
  ...
  return (
    <div className="notifs">
      <div className="notifs-header">
        ...
        {(hasUnreadSystem || notifications.some(n => n.isSmartNotification && !n.isRead)) && (
